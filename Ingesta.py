...
# token = "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"
# pabloToken = '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'
...
while totalcommits >= 0:
    ...
    rate =  requests.get(rate_url, params=query, headers=headers)
